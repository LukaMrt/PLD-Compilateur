...
public:
    ...
    virtual antlrcpp::Any visitPointer_expression(ifccParser::Pointer_expressionContext *ctx) override;
    virtual antlrcpp::Any visitAdress_of_expression(ifccParser::Adress_of_expressionContext *ctx) override;
